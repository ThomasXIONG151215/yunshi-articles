# 植物工厂光伏储能设计基准：一个仿真框架，5个气候带，10584种配置的数据支撑

## 📋 研究贡献

- **🎯 仿真框架**：建立含光伏、储能、负荷的联合仿真优化框架Vertical Farm Energy Designer (VFED)，基于上海全年实测数据验证模型准确性
- **💡 关键发现**：系统研究光周期起始时间对储能容量需求的影响，首次量化其贡献度——与光伏面积同等重要
...
研究发现，**光周期的起始时间对储能容量需求的影响与光伏面积同等重要**——以上海为例，将光周期从传统晚间调整至凌晨3-5点，可在保持相同光伏规模的同时减少40%储能容量需求。5城市分析显示，对于20尺集装箱植物工厂（16平方米种植面积），实现近能源自主所需的系统配置随气候差异显著：拉萨仅需40 m²光伏+40 kWh储能，哈尔滨则需120 m²光伏+50 kWh储能。本研究为植物工厂能源系统设计提供了可本地化参考的仿真工具与基准数据。
...
| 目标 | 城市 | 光伏面积 | 储能容量 | 电网依赖率 |
|------|------|----------|----------|-----------|
| 3年PBP | 拉萨 | 80 m² | 60-100 kWh | 7.2-15.9% |
| 3年PBP | 上海 | 100 m² | 80-100 kWh | 7.2-15.9% |
| 5年PBP | 拉萨 | 60-150 m² | 100-145 kWh | 84.1-92.8% |
| 5年PBP | 上海 | 80-150 m² | 100-145 kWh | 59.4-75.4% |
...
凌晨3-5点开始光周期的策略，可将储能需求削减40%，同时保持相同的能源自主水平。这将平准化能源成本（LCOE）降低至0.034 $/kWh，相比电网电价降低67%。
...
**开源框架**：vertical-farm-energy-designer - https://github.com/ThomasXIONG151215/vertical-farm-energy-designer

> **注**：框架名为Vertical Farm Energy Designer (VFED)，对应GitHub仓库为vertical-farm-energy-designer（仓库名遵循GitHub全小写规范）。
